# YGKing Music Web Player - Serverless Edition

专为 **Cloudflare Pages** 打造的纯前端 + Serverless 架构网页播放器。


<img src="images/Preview-Page.png" width="600" alt="Preview">
